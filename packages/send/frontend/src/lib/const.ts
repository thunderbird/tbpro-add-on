...
export const MAX_FILE_SIZE = ONE_GB_IN_BYTES * 10;
...
export const SEND_MESSAGE_TO_BRIDGE = 'SEND_MESSAGE_TO_BRIDGE';
export const TRANSFER_BRIDGE_MESSAGE = 'TRANSFER_BRIDGE_MESSAGE';
export const GET_LOGIN_STATE = 'GET_LOGIN_STATE';
export const LOGIN_STATE_RESPONSE = 'LOGIN_STATE_RESPONSE';
export const FORCE_CLOSE_WINDOW = 'FORCE_CLOSE_WINDOW';
export const OPEN_MANAGEMENT_PAGE = 'OPEN_MANAGEMENT_PAGE';
