...
export class TBAcctsPage {
  ...
  constructor(page: Page) {
    ...
    this.localDevEmailInput = this.page.getByTestId('email');
    this.localDevpasswordInput = this.page.getByTestId('password');
    this.localDevLoginContinueBtn = this.page.getByTestId('login-submit-button');
  }
